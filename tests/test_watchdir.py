...
async def test_do_new_watch_dir_already_download_tracker_still_searches_other_cross_seeds(tmp_path: Path):
    ...
    bhd_torrent_bytes = _create_sample_torrent_data("DLIndexer.Movie.1080p", 5000, "http://beyond-hd.me/announce", piece_length=32768)
    ...
    assert len(saved_files) == 2  # dropped download-indexer torrent + BeyondHD cross-seed
